<section class="section">
    ...
    echo 'php bpjs make:dto Yourdto<br>';
    echo 'php bpjs make:migration create_yourtable_table<br>';
    echo 'php bpjs make:job YourJob<br>';
    echo 'php bpjs db:migrate<br>';
    echo 'php bpjs db:rollback<br>';
    echo 'php bpjs generate:key<br>';
    echo 'php bpjs cache:route<br>';
    echo 'php bpjs cache:clear<br>';
    echo 'php bpjs queue:work<br>';
