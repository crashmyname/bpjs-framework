...
class SessionMiddleware {
    public static function start() {
        if (session_status() === PHP_SESSION_NONE) {
            ...
            ini_set('session.cookie_secure', false); // Aktifkan secure hanya jika HTTPS
            ini_set('session.cookie_httponly', false); // Mencegah akses JS ke cookie
            ini_set('session.cookie_samesite', 'Lax'); // Set SameSite ke None untuk lintas situs
